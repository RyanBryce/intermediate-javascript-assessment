...
var lSplit = lower.split(" ");
var newStr = '';
for (var i = 0; i < lSplit.length; i++) {
  newStr += lSplit[i].charAt(0).toUpperCase() + lSplit[i].slice(1) + ' '
}
return newStr.trim()
};
...
var valueType = (t1, t2) => {
  ...
  if (typeof t1 == typeof t2 && t1 === t2) {
    return "Exactly the same"
  }
  else if (t1 == t2 && typeof t1 != typeof t2) {
